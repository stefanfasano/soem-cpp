...
AbstractIMU::AbstractIMU(const std::string& name) : name(name), position(), quaternion(), angularVelocity(), linearAcceleration() {}
...
void AbstractIMU::setPosition(float x, float y, float z)
{
  position[0] = x;
  position[1] = y;
  position[2] = z;
...
void AbstractIMU::setQuaternion(float x, float y, float z, float s)
{
  quaternion[0] = x;
  quaternion[1] = y;
  quaternion[2] = z;
...
void AbstractIMU::setAngularVelocity(float x, float y, float z)
{
  angularVelocity[0] = x;
  angularVelocity[1] = y;
  angularVelocity[2] = z;
...
void AbstractIMU::setLinearAcceleration(float x, float y, float z)
{
